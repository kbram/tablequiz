...
$("body").on('click','.close',function(e) {     
    e.preventDefault();
       var id=$(this).closest('.article').find('.article_question').attr("id");
     if(id==null){
        count--;
        arcount--;
