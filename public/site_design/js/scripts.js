...
$('.card__from__modal').click(function(){
    ...
    $('body').on('click','.multiple__choice__row__in_modal span',function(){
        ...
        $(this).closest('.multiple__choice__row__in_modal').each(function(){
		      ...
		      var newRow ='<div class="form-row multiple__choice__row__in_modal pb-0 mb-2 align-items-center"><div class="col-7"><input name="multiple__choice__answer__1[]" class="readonly form-control" type="text"></div><div class="col-1 justify-content-center tempVis"><span class="minus">-</span></div><div class="col-1 justify-content-center tempVis"><span class="plus">+</span></div><div class="col-3 text-center form-check hidd"><input type="radio" class="" name="multiple__choice__correct__answer"></div></div></div>';
		      var parent = $(this);
