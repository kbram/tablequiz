jQuery(document).ready(function($){
	...
	slider.oninput = function() {
	  output.innerHTML = this.value;
		var newPercent = Number(100) + Number(this.value);
	  $('img.modal__edit__image__image').css({
		  'width': newPercent+'%',
		  'height': newPercent+'%'
	  })	
	...
	$('.multiple__choice__row').each(function(){
		var newRow ='<div class="row multiple__choice__row pb-3 align-items-center"><div class="col-7"><input name="multiple__choice__answer__1" class="form-control" type="text"></div><div class="col-1 justify-content-center"><span class="minus">-</span></div><div class="col-1 justify-content-center"><span class="plus">+</span></div><div class="col-3 text-center form-check"><input type="radio" class="" name="multiple__choice__correct__answer"></div></div>';
		var parent = $(this);
    ...
    var clicked = 0;
    $('#category__chosen__next').click(function(){
        clicked += 1;
