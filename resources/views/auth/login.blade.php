...
<!-- amount -->
			 ...
			 <div class="form-row">
				  ...
				  <div class="col-md-7">
					  <input class="form-control card-expiry-month" maxlength="2" min=0 oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);validity.valid||(value='');" max=12 size='2' type="number" name="cardholder_expiry_month" id="cardholder_expiry_month" value='{{ $payment_deatils->exp_month ?? ""}}'>
				  </div>
			 </div>
			 ...
			 <div class="form-row">
				  ...
				  <div class="col-md-7">
					  <input  class="form-control w-25 card-cvc" maxlength="3" min=0 oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); validity.valid||(value='');" type="number" name="card-cvc" id="card-cvc" value='{{ $payment_deatils->cvv ?? ""}}' size='3' >
				  </div>
			 </div>
