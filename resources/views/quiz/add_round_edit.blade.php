                                ...
                                <div class="col-9 the_answer">
                                    <div class="form-row multiple__choice__row__in_modal pb-0 mb-2 align-items-center">
                                        <div class="col input-group">
                                            <input name="multiple__choice__answer__1" class="form-control readonly" type="text" readonly value="Chisinau"><div class="input-group-prepend">
                                    ...
                                    <div class="form-row multiple__choice__row__in_modal pb-0 mb-2 align-items-center">
                                        <div class="col input-group">
                                            <input name="multiple__choice__answer__1" class="form-control readonly" type="text" readonly value="Kiev">		   <div class="input-group-prepend">
												<span class="input-group-text text-white border-danger bg-danger rounded-right d-none" id="basic-addon1"><i class="far fa-trash-alt"></i></span>
											  </div>
										</div>
                                        <div class="col-2 text-center form-check d-none">
                                    ...
                                    <div class="form-row multiple__choice__row__in_modal pb-0 mb-2 align-items-center">
                                        <div class="col input-group">
                                            <input name="multiple__choice__answer__1" class="readonly form-control" type="text" readonly value="Moscow">		  <div class="input-group-prepend">
												<span class="input-group-text text-white border-danger bg-danger rounded-right d-none" id="basic-addon1"><i class="far fa-trash-alt"></i></span>
											  </div>
                                    ...
                                    <div class="form-row multiple__choice__row__in_modal pb-0 mb-2 align-items-center">
                                        <div class="col input-group">
                                            <input name="multiple__choice__answer__1" class="form-control readonly" type="text" readonly value="Bucharest">	<div class="input-group-prepend">
												<span class="input-group-text text-white border-danger bg-danger rounded-right d-none" id="basic-addon1"><i class="far fa-trash-alt"></i></span>
											  </div>
                        ...
                        <li class="single__suggested__question text-body p-3 border rounded mb-4">
                            ...
                            <div class="single__suggested__question__answer row pb-3">
                                ...
                                <div class="col-9 the_answer">
                                    <div class="form-row multiple__choice__row__in_modal pb-0 mb-2 align-items-center">
                                        <div class="col input-group">
                                            <input name="multiple__choice__answer__1" class="form-control readonly" type="text" readonly value="Madagascar"><div class="input-group-prepend">
												<span class="input-group-text text-white border-danger bg-danger rounded-right d-none" id="basic-addon1"><i class="far fa-trash-alt"></i></span>
											  </div>
                                    ...
                                    <div class="form-row multiple__choice__row__in_modal pb-0 mb-2 align-items-center">
                                        <div class="col input-group">
                                            <input name="multiple__choice__answer__1" class="readonly form-control" type="text" readonly value="Chad">		  <div class="input-group-prepend">
												<span class="input-group-text text-white border-danger bg-danger rounded-right d-none" id="basic-addon1"><i class="far fa-trash-alt"></i></span>
											  </div>
                                    ...
                                    <div class="form-row multiple__choice__row__in_modal pb-0 mb-2 align-items-center">
                                        <div class="col input-group">
                                            <input name="multiple__choice__answer__1" class="form-control readonly" type="text" readonly value="South Sudan">	<div class="input-group-prepend">
												<span class="input-group-text text-white border-danger bg-danger rounded-right d-none" id="basic-addon1"><i class="far fa-trash-alt"></i></span>
											  </div>
