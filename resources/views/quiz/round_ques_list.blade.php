...
<section class="container page__inner">
   ...
   <section class="row round__page__buttons justify-content-center align-items-center pt-5 mt-5 border-top">
			...
			<div class="col-md-4 px-0 px-md-4">
				...
				<a href="/round/edit/{{$id}}/{{$rid+1}}"  id="nextRound" class="btn btn-primary  d-block">Next Round  <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
   ...
   <section class="row round__page__buttons justify-content-center align-items-center pt-5 mt-5 border-top">
            ...
            <div class="col-md-4 mb-3 mb-md-0 px-0 px-md-4" >
                ...
                <a href="/round/edit/{{$id}}/{{$rid-1}}"  id="preRound" class="btn btn-secondary  d-block"><i class="fa fa-chevron-left" aria-hidden="true"></i>  Previous Round </a>
			</div>
	</section>
